...
public class DepositoWindow extends Window {
	...
	public DepositoWindow(FacadeTransacao facadeTransacao, PrincipalLayout layout, Conta conta) {
		super();
		this.conta = conta;
		this.layout = layout;
		this.facadeTransacao = facadeTransacao;
		this.transacao = new DtoTransacao();
		transacao.setTipoTransacao(new DtoTipoTransacao("deposito", null, null));
